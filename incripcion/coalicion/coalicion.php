 ...
 <div id="inicio">
  ...
  <nav>
    <ul>
        ...
        <li><a href="/votacion2/incripcion/coalicion/manejadorcoalicion.php?accion=con">Modificar</a></li>
    ...
    <center><h1>Inscripcion De Candidato De Coalision</h1></center>
  <body>
...
?>
<center><div id="tex">
<form action="coalicion.php" method="get">
...
<center> <div class="jumbotron">
        <form action="manejadorcoalicion.php?accion=save" method="post" id="candidato">
...
?>
  ...
  <div class="row">
            ...
            <div class="col-xs-2">
                ...
                <div class="col-xs-2">
                   <select name='partido_dos' class="required form-control">
                    <option value=""></option>
                        <?php 
            ...
            <div class="col-xs-2">
                ...
                <div class="col-xs-2">
                   <select name='partido_tres' class="required form-control">
                    <option value=""></option>
                        <?php 
            ...
            <div class="col-xs-2">
                ...
                <div class="col-xs-2">
                   <select name='partido_cuatro' class="required form-control">
                    <option value=""></option>
                        <?php 
         ...
         <div class="col-xs-2">
            ...
            <div class="row">
             <div class="col-xs-2">
                ...
                <div class="col-xs-2">
                    <input type="text" name="coalicion" class="required  form-control">
 </div>
                <td colspan="2">
                   <center> <input type="submit" name='bot' value='Registrar' class="btn btn-primary"><center>
