...
<body>
 <header>
  ...
  <h1>TE ENCUENTRAS EN EL FORMULARIO DE INSCRIPCIONES PARA  PRESIDENTE</h1>
 ...
 <div id="inicio">
  ...
  <nav>
    <ul>
     ...
     <li><a href="/votacion2/incripcion/presidente/manejadorpresidente.php?accion=con">MODIFICAR</li></a>
...
?>
<div id="tex">
<form action="presidente.php" method="get">
