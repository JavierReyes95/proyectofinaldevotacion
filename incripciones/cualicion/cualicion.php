...
<body>
 <header>
  ...
  <h1>TE ENCUENTRAS EN EL FORMULARIO DE  INSCRIPCIONES PARA LAS COALICIONES</h1>
 ...
 <div id="inicio">
  ...
  <nav>
    <ul>
        ...
        <li><a href="/votacion2/incripcion/cualicion/manejadorcualicion.php?accion=con">MODIFICAR</a></li>
...
?>
<div id="tex">
<form action="cualicion.php" method="get">
...
<input type="submit" name="buscador" value="Buscar" class="btn btn-primary" /></p>
 ...
 <div class="jumbotron">
        <form action="manejadorcualicion.php?accion=save" method="post" id="candidato">
